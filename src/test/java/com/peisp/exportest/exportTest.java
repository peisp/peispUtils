...
public class exportTest {
    public static void main(String[] args) throws Exception {
        ...
        // 建立连接，查数据
        List<Map<String, Object>> maps = demoData("张三");
        String excelByData = ExportUtil.createExcelByData(new ExcelSheet(maps));
        ...
        String excelByData1 = ExportUtil.createExcelByData(new ExcelSheet(DBUtils.getSqlData(dataSource)));
        System.out.println(excelByData1);

    }


    public static List<Map<String, Object>> demoData(String name){
